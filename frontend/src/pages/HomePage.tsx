    ...
    <div className="home-page">
      <Box sx={{ display: 'flex', flexDirection: 'row', mt: 3, justifyContent: 'center', gap: 5 }}>
        <Box>
          ...
          <div className='home-body'>
            <Box sx={{ backgroundColor: "#cbd5e1" }}>
              <Card sx={{ width: '4rem', height: "4rem", display: 'flex', justifyContent: 'center', alignItems: 'center' }} onClick={handleAddFormClick}>
                <AddIcon />
              </Card>
            </Box>
          </div>
        ...
        <Box>
          ...
          <div className='home-body'>
            <Box sx={{ backgroundColor: "#cbd5e1" }}>
              <Card sx={{ width: '4rem', height: "4rem", display: 'flex', justifyContent: 'center', alignItems: 'center' }} onClick={handleAddTestClick}>
                <AddIcon />
              </Card>
            </Box>
          </div>
