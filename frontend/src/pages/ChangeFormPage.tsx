...
import { Alert, AppBar, Box, Button, Dialog, DialogActions, DialogContent, DialogContentText, DialogTitle, Fab, Fade, FormControl, FormControlLabel, Grid, IconButton, InputLabel, MenuItem, Paper, Slide, SlideProps, Snackbar, Switch, Tabs, TextField, Toolbar, Tooltip, Typography } from '@mui/material';
				...
				<Box sx={{ flexGrow: 1 }}>
					<AppBar position="static" sx={{ backgroundColor: "white" }}>
						<Toolbar sx={{ justifyContent: 'space-between', alignItems: 'center' }}>
							...
							<Button variant="contained" onClick={SendCards} color="success">Изменить</Button>
						</Toolbar>
